...
Note: Before starting this, the destination (location the remote user is connecting to) router must have certain ports configured for IPsec port-forwarding. Please refer to `2.0_IPsecVPN-Port-Forwarding.md` on how to set that up.

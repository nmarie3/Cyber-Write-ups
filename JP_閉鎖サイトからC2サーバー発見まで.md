...
（もしかしたら、リダイレクトをどうやって見つけたのか記憶が曖昧なだけかもしれない。ただ、何らかの形で見つけたのは確かで、そうでなければこの調査はそこで終わっていた。）
...
![alt text](DeadtoC2images/page-results.png)
...
さらに推測できることとして、今回の調査の発端となったdkaksdaksortor[.]comも、悪意あるJavaScriptと感染済みPHPウェブシェルを仕込んだ偽CloudflareのCAPTCHAページを置いていた踏み台サイトの一つだったと考えられる。
